...
func True() tgo.Filter {
	return NewFilter(func(update *tg.Update) bool { return true })
}

// False does nothing and just always returns false.
func False() tgo.Filter {
	return NewFilter(func(update *tg.Update) bool { return false })
}
...
func Not(filter tgo.Filter) tgo.Filter {
	return NewFilter(func(update *tg.Update) bool { return !filter.Check(update) })
}
